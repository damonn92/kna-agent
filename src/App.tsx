...
import { useKnaDeepLink } from '@/hooks/use-kna-deep-link';
...
function App() {
  ...
  // Subscribe to kna-desktop:// deep-links (browser-SSO callback).
  // Owns parsing → upserting the KNA provider account → toast feedback.
  useKnaDeepLink();
