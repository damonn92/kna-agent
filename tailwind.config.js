...
/* ──────────────────────────────────────────────────────────────────────────
 * KNA Agent Tailwind design tokens
 * ──────────────────────────────────────────────────────────────────────────
 *
 * This config layers KNA Agent's own visual language on top of shadcn/ui:
 *
 ...
 *      ...) we add three KNA Agent-private groups:
 ...
 *
 *   4. Naming — All KNA Agent-private tokens live under their own top-level
...
module.exports = {
  ...
  theme: {
    ...
    extend: {
       ...
       * change only edits the values here. KNA Agent's full size ladder
       * (combining Tailwind defaults + KNA Agent additions, smallest first):
       *
       *   ┌──────────────┬──────────┬─────────────┬──────────────────────────────┐
       ...
       *   B. KNA Agent brand tokens (brand / skill) — plain hex values that
       *      do not change between light and dark themes.
       *   C. KNA Agent surface tokens (surface.{modal,input,sidebar}) — use
